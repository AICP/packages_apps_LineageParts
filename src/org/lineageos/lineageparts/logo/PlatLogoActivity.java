...
public class PlatLogoActivity extends Activity {
            ...
            if (mCount <= 3) {
                ...
                try {
                    startActivity(new Intent(Intent.ACTION_MAIN)
                        ...
                        .setClassName("org.lineageos.lineageparts","org.lineageos.lineageparts.logo.Nyandroid"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContent.setImageResource(org.lineageos.lineageparts.R.drawable.platlogo_aicp);
